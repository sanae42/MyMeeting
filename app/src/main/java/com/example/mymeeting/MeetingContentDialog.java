...
public class MeetingContentDialog extends Dialog {

    public MeetingContentDialog(Context context) {
        super(context);
    }

    public MeetingContentDialog(Context context, int theme) {
        super(context, theme);
    }
    ...
    public static class Builder {
        ...
        public MeetingContentDialog create() {
            LayoutInflater inflater = (LayoutInflater) context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            // instantiate the dialog with the custom Theme
            final MeetingContentDialog dialog = new MeetingContentDialog(context);
            View layout = inflater.inflate(R.layout.dialog_meeting_content, null);
